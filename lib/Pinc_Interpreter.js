  ...
  while(true) {
    ...
    switch (s.TAG | 0) {
      ...
      case /* HtmlTemplateNode */9 :
          ...
          if (s._3 && Pinc_HTML.is_void_el(tag)) {
...
function compare(a, b) {
  if (typeof a === "number") {
    ...
    switch (a.TAG | 0) {
      ...
      case /* Bool */3 :
          if (typeof b === "number") {
            var Internal_Error$4 = /* @__PURE__ */Caml_exceptions.create("Internal_Error");
            throw {
                  RE_EXN_ID: Internal_Error$4,
                  Error: new Error()
                };
          }
          switch (b.TAG | 0) {
      ...
      case /* Array */4 :
          if (typeof b === "number") {
            var Internal_Error$5 = /* @__PURE__ */Caml_exceptions.create("Internal_Error");
            throw {
                  RE_EXN_ID: Internal_Error$5,
                  Error: new Error()
                };
          }
          switch (b.TAG | 0) {
      ...
      case /* Record */5 :
          if (typeof b === "number") {
            var Internal_Error$6 = /* @__PURE__ */Caml_exceptions.create("Internal_Error");
            throw {
                  RE_EXN_ID: Internal_Error$6,
                  Error: new Error()
                };
          }
          switch (b.TAG | 0) {
      ...
      case /* Function */6 :
          if (typeof b === "number") {
            var Internal_Error$7 = /* @__PURE__ */Caml_exceptions.create("Internal_Error");
            throw {
                  RE_EXN_ID: Internal_Error$7,
                  Error: new Error()
                };
          }
          switch (b.TAG | 0) {
      ...
      case /* DefinitionInfo */7 :
          if (typeof b === "number") {
            var Internal_Error$8 = /* @__PURE__ */Caml_exceptions.create("Internal_Error");
            throw {
                  RE_EXN_ID: Internal_Error$8,
                  Error: new Error()
                };
          }
          switch (b.TAG | 0) {
          ...
          break;
      case /* TagInfo */8 :
          var Internal_Error$9 = /* @__PURE__ */Caml_exceptions.create("Internal_Error");
          throw {
                RE_EXN_ID: Internal_Error$9,
                Error: new Error()
              };
      case /* HtmlTemplateNode */9 :
          if (typeof b === "number") {
            var Internal_Error$10 = /* @__PURE__ */Caml_exceptions.create("Internal_Error");
            throw {
                  RE_EXN_ID: Internal_Error$10,
                  Error: new Error()
                };
          }
          switch (b.TAG | 0) {
      ...
      case /* ComponentTemplateNode */10 :
          if (typeof b === "number") {
            var Internal_Error$11 = /* @__PURE__ */Caml_exceptions.create("Internal_Error");
            throw {
                  RE_EXN_ID: Internal_Error$11,
                  Error: new Error()
                };
          }
          switch (b.TAG | 0) {
  ...
  var Internal_Error$12 = /* @__PURE__ */Caml_exceptions.create("Internal_Error");
  throw {
        RE_EXN_ID: Internal_Error$12,
        Error: new Error()
      };
}
  ...
  switch (i.TAG | 0) {
        ...
        if (value !== undefined) {
          switch (value.TAG | 0) {
            ...
            case /* LibraryDeclaration */1 :
                var declaration = eval_declaration(state, value);
    ...
    case /* TagExpression */10 :
        ...
        var attributes$1 = match !== undefined ? (
            typeof match === "number" || match.TAG !== /* String */0 ? Stdlib.failwith("Expected attribute `key` on tag to be of type string") : attributes
          ) : (
                    ...
                    switch (right$15.TAG | 0) {
                      case /* UppercaseIdentifierExpression */8 :
                          ...
                          if (match$4 !== undefined) {
                            ...
                            if (match$4.TAG !== /* DefinitionInfo */7) {
                              return Stdlib.failwith("Trying to access a property on a non record, library or template value.");
                            }
                      ...
                      case /* LowercaseIdentifierExpression */9 :
                          ...
                          if (match$6 !== undefined) {
                            ...
                            if (match$6.TAG !== /* DefinitionInfo */7) {
                              return Stdlib.failwith("Trying to access a property on a non record, library or template value.");
                            }
