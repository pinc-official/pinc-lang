...
function eval_tag(value, state, tag) {
  ...
  var apply_default_value = function ($$default, value) {
    if ($$default !== undefined && typeof value === "number") {
      return Curry._1(State.get_output, eval_expression(state, $$default));
    } else {
      return value;
    }
  };
  ...
  var get_key = function (attributes) {
    var key = $$Option.map(State.get_output, $$Option.map((function (param) {
  ...
  switch (tag_name) {
    ...
    case "GetContext" :
        ...
        var s = Curry._1(State.get_output, eval_expression(state, name !== undefined ? name : Stdlib.failwith("attribute name is required when getting a context.")));
        var name$1;
        name$1 = typeof s === "number" || s.TAG !== /* String */0 ? Stdlib.failwith("Expected attribute `name` on #Context to be of type string.") : s._0;
        var value$7 = apply_default_value($$default$3, $$Option.value(Curry._2(State.get_context, name$1, state), /* Null */0));
    ...
    case "SetContext" :
        ...
        var s$1 = Curry._1(State.get_output, eval_expression(state, name$2 !== undefined ? name$2 : Stdlib.failwith("attribute name is required when setting a context.")));
        var name$3;
        name$3 = typeof s$1 === "number" || s$1.TAG !== /* String */0 ? Stdlib.failwith("Expected attribute `name` on >#Context to be of type string.") : s$1._0;
        var value$12 = Curry._2(Pinc_Ast.StringMap.find_opt, "value", attributes$6);
        var value$13 = Curry._1(State.get_output, eval_expression(state, value$12 !== undefined ? value$12 : Stdlib.failwith("attribute value is required when setting a context.")));
        return Curry._2(State.add_output, /* Null */0, Curry._3(State.add_context, name$3, value$13, state));
    case "Slot" :
        var attributes$7 = tag.attributes;
        var s$2 = $$Option.value($$Option.map(State.get_output, $$Option.map((function (param) {
                        return eval_expression(state, param);
        ...
        var i$1 = $$Option.value($$Option.map(State.get_output, $$Option.map((function (param) {
                        return eval_expression(state, param);
        ...
        var param = $$Option.map(State.get_output, $$Option.map((function (param) {
                    return eval_expression(state, param);
        ...
        var param$1 = $$Option.map(State.get_output, $$Option.map((function (param) {
                    return eval_expression(state, param);
    ...
    case "String" :
        ...
        var s$3 = apply_default_value($$default$5, value$14);
        var value$15;
