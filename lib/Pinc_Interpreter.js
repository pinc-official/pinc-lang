          ...
          case /* DOT_ACCESS */15 :
              ...
              switch (left$1.TAG | 0) {
                case /* Record */5 :
                    ...
                    var output = $$Option.value(Curry._2(StringMap.find_opt, right$15._0._0, left$1._0), /* Null */0);
                    return add_output(output, state);
                case /* DefinitionInfo */7 :
                    var match$3 = left$1._0[1];
                    if (match$3 === undefined) {
                      return Stdlib.failwith("Trying to access a property on a non existant library.");
                    }
                    if (typeof match$3 !== "string" && match$3.NAME === "Library") {
                      if (right$15.TAG !== /* LowercaseIdentifierExpression */9) {
                        return Stdlib.failwith("I am really not sure what you are trying to do here...");
                      }
                      var binding = List.assoc_opt(right$15._0._0, match$3.VAL);
