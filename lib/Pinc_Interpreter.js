  ...
  if (typeof a === "string") {
    ...
    if (variant === "String") {
      ...
      if (typeof b !== "string" && b.NAME === "DefinitionInfo") {
        return $$String.equal(a.VAL.name, b.VAL.name);
      }
...
function make(modelsOpt, tag_listenersOpt, slotted_children, declarations) {
...
function eval_expression(state, i) {
  switch (i.TAG | 0) {
    ...
    case /* TagExpression */10 :
        ...
        var tag_transformer = function (param) {
    ...
    case /* UnaryExpression */15 :
        if (i._0) {
          ...
          var match$2 = Curry._1(State.get_output, eval_expression(state, expression$1));
              ...
              if (typeof left$4 !== "string") {
                ...
                if (variant$22 === "Record") {
                  if (typeof right$23 !== "string" && right$23.NAME === "Record") {
                    return Curry._2(State.add_output, {
                                NAME: "Record",
                                VAL: Curry._3(Pinc_Ast.StringMap.merge, (function (param, x, y) {
                                        if (x !== undefined) {
                                          if (y !== undefined) {
                                            return y;
                                          } else {
                  ...
                  if (variant$22 === "TemplateNode") {
                    ...
                    var attributes$2 = Curry._3(Pinc_Ast.StringMap.merge, (function (param, x, y) {
                            if (x !== undefined) {
                              if (y !== undefined) {
                                return y;
                              } else {
  ...
  switch (template.TAG | 0) {
    ...
    case /* ComponentTemplateNode */1 :
        ...
        var component_tag_listeters = Curry._3(Pinc_Ast.StringMap.add, "#Slot", (function (param) {
                ...
                return Curry._1(param.transformer, {
                    ...
                    var of$p = param$2 !== undefined ? (
                        typeof param$2 === "string" || param$2.NAME !== "TagInfo" ? Stdlib.failwith("Expected attribute `of` #Array to be a tag describing the type of the items inside.") : param$2.VAL
                    ...
                    var arg = Curry._1(Value.$$null, undefined);
                    var v = Curry._2(Pinc_Ast.StringMap.find_opt, key, attributes$1);
                    var param$3 = validate$5((function (param) {
                              return $$Option.value(param, arg);
                            })(v !== undefined ? v : $$default));
                    return Curry._1(param.transformer, typeof param$3 === "string" ? "Null" : ({
                                    NAME: "Record",
                                    VAL: Curry._2(Pinc_Ast.StringMap.map, (function (value) {
                                            return Curry._1(of$p.transformer, value);
                                          }), param$3.VAL)
                                  }));
                        ...
                        var arg = Curry._1(Value.$$null, undefined);
                        var v = Curry._2(Pinc_Ast.StringMap.find_opt, key, attributes$1);
                        var param$3 = validate$4((function (param) {
                                  return $$Option.value(param, arg);
                                })(v !== undefined ? v : $$default));
                        return Curry._1(param.transformer, typeof param$3 === "string" ? "Null" : ({
                                        NAME: "Array",
                                        VAL: $$Array.map((function (value) {
                                                return Curry._1(of$p.transformer, value);
                                              }), param$3.VAL)
                                      }));
                            ...
                            var arg = Curry._1(Value.$$null, undefined);
                            var v = Curry._2(Pinc_Ast.StringMap.find_opt, key, attributes$1);
                            return Curry._1(param.transformer, validate$3((function (param) {
                                                return $$Option.value(param, arg);
                                              })(v !== undefined ? v : $$default)));
                                ...
                                var arg = Curry._1(Value.$$null, undefined);
                                var v = Curry._2(Pinc_Ast.StringMap.find_opt, key, attributes$1);
                                return Curry._1(param.transformer, validate$2((function (param) {
                                                    return $$Option.value(param, arg);
                                                  })(v !== undefined ? v : $$default)));
                                    ...
                                    var arg = Curry._1(Value.$$null, undefined);
                                    var v = Curry._2(Pinc_Ast.StringMap.find_opt, key, attributes$1);
                                    return Curry._1(param.transformer, validate$1((function (param) {
                                                        return $$Option.value(param, arg);
                                                      })(v !== undefined ? v : $$default)));
                                        ...
                                        var arg = Curry._1(Value.$$null, undefined);
                                        var v = Curry._2(Pinc_Ast.StringMap.find_opt, key, attributes$1);
                                        return Curry._1(param.transformer, validate((function (param) {
                                                            return $$Option.value(param, arg);
                                                          })(v !== undefined ? v : $$default)));
                                      }), Pinc_Ast.StringMap.empty)))))));
        var tag_listeners = Curry._3(Pinc_Ast.StringMap.merge, (function (_key, x, y) {
                if (x !== undefined) {
                  if (y !== undefined) {
                    return y;
                  } else {
        ...
        var render_fn = function (models, slotted_children) {
          var state$1 = Curry._4(State.make, models, Caml_option.some(tag_listeners), slotted_children, state.declarations);
...
function $$eval(tag_listeners, models, slotted_children, root, declarations) {
  ...
  var default_tag_listeters = Curry._3(Pinc_Ast.StringMap.add, "#GetContext", (function (param) {
          ...
          return Curry._1(param.transformer, validate$7((function (param) {
                              return $$Option.value(param, arg);
                            })(v !== undefined ? v : $$default)));
              ...
              return Curry._1(param.transformer, validate$6(Curry._1(Value.$$null, undefined)));
            }), Pinc_Ast.StringMap.empty));
  var tag_listeners$1 = tag_listeners !== undefined ? Curry._3(Pinc_Ast.StringMap.merge, (function (_key, x, y) {
            if (x !== undefined) {
              return x;
            } else if (y !== undefined) {
              return y;
  ...
  var state = Curry._4(State.make, models, Caml_option.some(tag_listeners$1), slotted_children, declarations);
...
function from_source(models, slotted_children, filenameOpt, source, root) {
  ...
  return $$eval(undefined, models, slotted_children, root, declarations);
}
