...
function eval_template(state, template) {
  switch (template.TAG | 0) {
    ...
    case /* ComponentTemplateNode */1 :
        ...
        var component_tag_listeters = Curry._3(StringMap.add, "#Slot", Pinc_Tags.make_slot(children$1), Curry._3(StringMap.add, "#Record", Pinc_Tags.make_record(attributes$1), Curry._3(StringMap.add, "#Array", Pinc_Tags.make_array(attributes$1), Curry._3(StringMap.add, "#Boolean", Pinc_Tags.make_boolean(attributes$1), Curry._3(StringMap.add, "#Float", Pinc_Tags.make_float(attributes$1), Curry._3(StringMap.add, "#Int", Pinc_Tags.make_int(attributes$1), Curry._3(StringMap.add, "#String", Pinc_Tags.make_string(attributes$1), StringMap.empty)))))));
        ...
        var render_fn = function (param) {
          var state$1 = Curry._2(Pinc_Interpreter_Generic.State.make, Caml_option.some(tag_listeners), state.declarations);
...
function $$eval(tag_listeners, root, declarations) {
  ...
  var default_tag_listeters = Curry._3(StringMap.add, "#GetContext", Pinc_Tags.make_get_context(context), Curry._3(StringMap.add, "#SetContext", Pinc_Tags.make_set_context(context), StringMap.empty));
  ...
  var state = Curry._2(Pinc_Interpreter_Generic.State.make, Caml_option.some(tag_listeners$1), declarations);
