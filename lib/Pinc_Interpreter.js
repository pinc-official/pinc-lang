...
function call_tag_listener(state, value, t) {
  ...
  if (typeof tag === "string") {
    if (tag === "Boolean") {
      v = listener !== undefined && !(typeof listener === "string" || listener.NAME !== "Boolean") ? Curry._3(listener.VAL, required, attributes, key) : Result.ok(/* Null */0);
    } else if (tag === "Int") {
      v = listener !== undefined && !(typeof listener === "string" || listener.NAME !== "Int") ? Curry._3(listener.VAL, required, attributes, key) : Result.ok(/* Null */0);
    } else if (tag === "Float") {
      v = listener !== undefined && !(typeof listener === "string" || listener.NAME !== "Float") ? Curry._3(listener.VAL, required, attributes, key) : Result.ok(/* Null */0);
    } else if (tag === "Record") {
      ...
      v = listener !== undefined && !(typeof listener === "string" || listener.NAME !== "Slot") ? Curry._3(listener.VAL, required, attributes, key) : Result.ok(/* Null */0);
    } else if (tag === "Array") {
      ...
      v = listener !== undefined && !(typeof listener === "string" || listener.NAME !== "String") ? Curry._3(listener.VAL, required, attributes, key) : Result.ok(/* Null */0);
    }
  } else {
    v = listener !== undefined && !(typeof listener === "string" || listener.NAME !== "Custom") ? Curry._5(listener.VAL, tag.VAL, required, attributes, value, key) : Result.ok(/* Null */0);
  }
  if (v.TAG === /* Ok */0) {
