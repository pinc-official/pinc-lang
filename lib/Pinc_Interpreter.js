      ...
      case "Record" :
          ...
          var of$p$1 = t$1 !== undefined ? Curry._2(Pinc_Ast.StringMap.mapi, (function (key, param) {
                    ...
                    if (expr.TAG === /* TagExpression */10) {
                      ...
                      return Stdlib.failwith("expected property `" + (key + "` on record tag to be a tag, describing the type of the property."));
                    }
        ...
        switch (value$7.TAG | 0) {
          ...
          case /* Record */5 :
              ...
              var eval_property = function (key, param) {
                ...
                if (typeof value === "number" && !param[0]) {
                  return Stdlib.failwith("property `" + (key + "` on record tag is not marked as nullable, but was given a null value."));
                } else {
                  return value;
                }
              };
