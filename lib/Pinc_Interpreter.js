  ...
  while(true) {
    ...
    switch (p.TAG | 0) {
      ...
      case /* HtmlTemplateNode */10 :
          ...
          if (p._3 && Pinc_HTML.is_void_el(tag)) {
...
function is_true(b) {
  ...
  switch (b.TAG | 0) {
    case /* Portal */0 :
        return Stdlib.failwith("Portals may not be used inside conditional checks");
    case /* String */1 :
          ...
          switch (p.TAG | 0) {
            ...
            case /* String */1 :
                var l = loop(/* [] */0, $$Array.to_list($$Array.map((function (c) {
                              ...
                              }), Curry._1(maybe_rev, $$Array.of_seq($$String.to_seq(p._0))))));
                var res$1 = {
                  TAG: /* Array */5,
                  _0: $$Array.of_list(l)
                };
            ...
            case /* Array */5 :
                var l$1 = loop(/* [] */0, $$Array.to_list(Curry._1(maybe_rev, p._0)));
                var res$2 = {
                  TAG: /* Array */5,
                  _0: $$Array.of_list(l$1)
                };
                return add_output(res$2, state);
            case /* Record */6 :
        ...
        switch (i._1) {
          ...
          case /* ARRAY_ADD */19 :
              ...
              var add = function (left, right) {
                ...
                switch (left.TAG | 0) {
                  case /* Portal */0 :
                      var res = add(left._0, right).output;
                      return add_output({
                                  TAG: /* Portal */0,
                                  _0: res
                                }, state);
                  case /* Array */5 :
                      return add_output({
                                  TAG: /* Array */5,
                                  _0: $$Array.append(left._0, [right])
                                }, state);
                  default:
                    return Stdlib.failwith("Trying to add an element on a non array value.");
                }
              };
              return add(left$3, right$21);
          case /* MERGE */20 :
              var right$22 = i._2;
              ...
              var merge = function (left, right) {
                  ...
                  switch (left.TAG | 0) {
                    case /* Portal */0 :
                        ...
                        if (typeof right === "number") {
                          ...
                          if (right.TAG === /* Portal */0) {
                            var res = merge(left$1, right._0).output;
                            return add_output({
                                        TAG: /* Portal */0,
                                        _0: res
                                      }, state);
                        ...
                        if (exit$2 === 4) {
                          var res$1 = merge(left$1, right).output;
                          return add_output({
                                      TAG: /* Portal */0,
                                      _0: res$1
                                    }, state);
                ...
                if (exit$1 === 3) {
                  if (typeof right === "number") {
                    ...
                    if (right.TAG === /* Portal */0) {
                      var res$2 = merge(left, right._0).output;
                      return add_output({
                                  TAG: /* Portal */0,
                                  _0: res$2
                                }, state);
...
function eval_range(state, inclusive, from, upto) {
  ...
  var get_range = function (_from, _upto) {
    while(true) {
      var upto = _upto;
      var from = _from;
      var exit = 0;
      ...
      if (exit === 2 && typeof from !== "number" && from.TAG === /* Int */2) {
...
function $$eval(tag_listeners, root, declarations) {
  ...
  var collected_portal_values = Hashtbl.fold((function (_key, value, param) {
          if (param) {
            return true;
          } else {
        ...
        }), state$1.portals, false);
  if (collected_portal_values) {
