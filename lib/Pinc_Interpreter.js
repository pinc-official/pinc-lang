        ...
        if (value !== undefined) {
          switch (value.TAG | 0) {
            ...
            case /* LibraryDeclaration */1 :
                var t = eval_declaration(state, value);
                var top_level_bindings = List.hd(t.environment.scope);
                typ = {
                  NAME: "Library",
        ...
        switch (i._1) {
          ...
          case /* DOT_ACCESS */15 :
              ...
              if (typeof left$1 === "string") {
                ...
                if (variant$20 === "DefinitionInfo") {
                  var match$4 = left$1.VAL[1];
                  if (match$4 === undefined) {
                    return Stdlib.failwith("Trying to access a property on a non existant library.");
                  }
                  if (typeof match$4 !== "string" && match$4.NAME === "Library") {
                    ...
                    var binding = List.assoc_opt(right$15._0._0, match$4.VAL);
                    if (binding !== undefined) {
                      return add_output(binding.value, state);
                    } else {
                      return add_output("Null", state);
                    }
                  }
                  
                } else if (variant$20 === "HtmlTemplateNode") {
                  if (right$15.TAG !== /* LowercaseIdentifierExpression */9) {
                    return Stdlib.failwith("I am really not sure what you are trying to do here...");
                  }
