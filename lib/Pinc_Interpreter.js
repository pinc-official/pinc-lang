...
function eval_expression(state, i) {
  switch (i.TAG | 0) {
    ...
    case /* TagExpression */10 :
        ...
        var attributes = Curry._2(StringMap.mapi, (function (key, it) {
        ...
        var match$2;
        if (match !== undefined) {
          match$2 = typeof match === "number" || match.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `key` on tag to be of type string") : [
              attributes,
              match._0
            ];
        ...
        if (state.tag_info) {
          ...
          value$1 = match$3 ? (
              tag_name !== "CreatePortal" ? $$Option.value($$Option.bind(Hashtbl.find_opt(state.tag_cache, key$1), Queue.take_opt), /* Null */0) : call_tag_listener("#" + tag_name, tag$1, state)
            ) : call_tag_listener("#" + tag_name, tag$1, state);
        }
        if (state.mode === /* Portal_Collection */0) {
          var q = Hashtbl.find_opt(state.tag_cache, key$1);
          if (q !== undefined) {
            Queue.add(value$1, Caml_option.valFromOption(q));
          } else {
            var q$1 = Queue.create(undefined);
            Queue.add(value$1, q$1);
            Hashtbl.add(state.tag_cache, key$1, q$1);
          }
        }
    ...
    case /* UnaryExpression */15 :
        if (i._0) {
          ...
          var match$4 = v._0;
          var negated = match$4[2] === "Negated" ? "NotNegated" : "Negated";
          return add_output({
                      TAG: /* DefinitionInfo */8,
                      _0: [
                        match$4[0],
        ...
        switch (i._1) {
          ...
          case /* DOT_ACCESS */15 :
              ...
              switch (left$1.TAG | 0) {
                ...
                case /* DefinitionInfo */8 :
                    var match$5 = left$1._0;
                    var maybe_library = match$5[1];
                    var name = match$5[0];
                    switch (right$15.TAG | 0) {
                      ...
                      case /* LowercaseIdentifierExpression */9 :
                          var match$8 = List.assoc_opt(name, state.environment.use_scope);
                          var top_level_bindings$1;
                          if (match$8 !== undefined) {
                            if (typeof match$8 === "number") {
                              return Stdlib.failwith("Trying to access a property on a non record, library or template value.");
                            }
                            if (match$8.TAG !== /* DefinitionInfo */8) {
                              return Stdlib.failwith("Trying to access a property on a non record, library or template value.");
                            }
                            var match$9 = match$8._0[1];
                            ...
                            if (match$9.NAME !== "Library") {
                              return Stdlib.failwith("Trying to access a property on a non record, library or template value.");
                            }
                            top_level_bindings$1 = match$9.VAL[0];
                          } else {
                            if (maybe_library === undefined) {
                              return add_output(/* Null */0, state);
                            }
              ...
              if (typeof left$4 !== "number") {
                switch (left$4.TAG | 0) {
                  ...
                  case /* ComponentTemplateNode */11 :
                      ...
                      var result = Curry._1(fn$1, attributes$2);
                      return add_output({
                                  TAG: /* ComponentTemplateNode */11,
                                  _0: fn$1,
                                  _1: left$4._1,
...
function get_tag_listeners(l) {
  ...
  if (l !== undefined) {
    return Curry._3(StringMap.union, (function (_key, _x, y) {
                  return y;
                }), Caml_option.valFromOption(l), default_tag_listeners);
  } else {
    return default_tag_listeners;
  }
}

function eval_meta(tag_listeners, declarations) {
  var tag_listeners$1 = get_tag_listeners(tag_listeners);
  var state = make(Caml_option.some(tag_listeners$1), undefined, undefined, undefined, undefined, /* Render */1, declarations);
...
function $$eval(tag_listeners, root, declarations) {
  var tag_listeners$1 = get_tag_listeners(tag_listeners);
  var state = make(Caml_option.some(tag_listeners$1), undefined, undefined, undefined, undefined, /* Portal_Collection */0, declarations);
