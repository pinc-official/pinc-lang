...
function get_tags(t) {
  return Curry._1(Pinc_Ast.StringMap.bindings, t.tags);
}

function add_tag(typ, key, t) {
  var value = {
    typ: typ
  };
  return {
          ...
          output: t.output,
          environment: t.environment,
          tags: Curry._3(Pinc_Ast.StringMap.add, key, value, t.tags)
        };
}
  ...
  switch (i.TAG | 0) {
                              ...
                              return Stdlib.failwith(Curry._1(Printf.sprintf(/* Format */{
                                                  _0: {
                                                    ...
                                                    _1: {
                                                      ...
                                                      _1: {
                                                        TAG: /* String_literal */11,
                                                        _0: " is not marked as nullable, but was given a null value.",
                                                        _1: /* End_of_format */0
                                                      }
                                                    }
                                                  },
                                                  _1: "identifier %s is not marked as nullable, but was given a null value."
                                                }), ident));
                            } else {
                              return value;
                            }
    ...
    case /* Function */6 :
        ...
        var exec = function ($$arguments, state, param) {
          ...
          return eval_block(state$2, body).output;
        };
        var fn = {
          TAG: /* Function */6,
    ...
    case /* LowercaseIdentifierExpression */9 :
        ...
        if (param !== undefined) {
          ...
          return Stdlib.failwith(Curry._1(Printf.sprintf(/* Format */{
                              ...
                              _1: "Unbound identifier `%s`"
                            }), ident$1));
        }
    case /* OptionalLetExpression */10 :
        return eval_let(state, i._1._0, i._0, true, i._2);
    case /* LetExpression */11 :
        return eval_let(state, i._1._0, i._0, false, i._2);
    case /* MutationExpression */12 :
        var ident$2 = i._0._0;
        var expression = i._1;
        var current_binding = get_value_from_scope(ident$2, state);
        ...
        if (typeof value$1 === "number" && !current_binding.is_optional) {
          Stdlib.failwith(Curry._1(Printf.sprintf(/* Format */{
                        _0: {
                          ...
                          _1: {
                            ...
                            _1: {
                              TAG: /* String_literal */11,
                              _0: " is not marked as nullable, but was tried to be updated with a null value.",
                              _1: /* End_of_format */0
                            }
                          }
                        },
                        _1: "identifier %s is not marked as nullable, but was tried to be updated with a null value."
                      }), ident$2));
        } else {
          update_value_in_scope(ident$2, value$1, state);
        }
        return add_output(/* Null */0, state);
    case /* TagExpression */13 :
        return eval_tag(undefined, state, i._0);
    case /* BreakExpression */14 :
        if (is_true(eval_expression(state, i._0).output)) {
          throw {
    ...
    case /* ContinueExpression */15 :
        ...
        return add_output(/* Null */0, state);
    case /* ForInExpression */16 :
        var index_ident = i.index;
        var ident$3 = i.iterator._0;
        ...
        var loop = function (_acc, _param) {
          while(true) {
            ...
            var state$1 = add_value_to_scope(ident$3, param.hd, false, false, state);
    ...
    case /* BlockExpression */18 :
        return eval_block(state, i._0);
    case /* ConditionalExpression */19 :
        var condition = i.condition;
        var alternate = i.alternate;
        var consequent = i.consequent;
        if (is_true(eval_expression(state, condition).output)) {
          return eval_block(state, consequent);
        } else if (alternate !== undefined) {
          return eval_block(state, alternate);
        } else {
          return add_output(/* Null */0, state);
        }
    case /* UnaryExpression */20 :
        if (i._0) {
          var expression$1 = i._1;
          var info = eval_expression(state, expression$1).output;
          ...
          var expression$2 = i._1;
          var i$1 = eval_expression(state, expression$2).output;
          ...
          case /* DOT_ACCESS */15 :
              ...
              switch (left$1.TAG | 0) {
                case /* Record */5 :
                    ...
                    var output$1 = $$Option.value(Curry._2(Pinc_Ast.StringMap.find_opt, right$15._0._0, left$1._0), /* Null */0);
                        ...
                        return Stdlib.failwith(Curry._1(Printf.sprintf(/* Format */{
                                            _0: {
                                              ...
                                              _1: {
                                                ...
                                                _1: {
                                                  TAG: /* String_literal */11,
                                                  _0: " on template node. Known properties are: `tag`, `attributes` and `children`.",
                                                  _1: /* End_of_format */0
                                                }
                                              }
                                            },
                                            _1: "Unknown property %s on template node. Known properties are: `tag`, `attributes` and `children`."
                                          }), b$23));
                    }
                default:
                  if (right$15.TAG === /* LowercaseIdentifierExpression */9) {
          ...
          case /* BRACKET_ACCESS */16 :
              ...
              switch (left$2.TAG | 0) {
                case /* Array */4 :
                    ...
                    var output$2;
                    try {
                      output$2 = Caml_array.get(left$2._0, right$17._0);
                    }
                    catch (raw_exn){
                      var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
                ...
                case /* Record */5 :
                    ...
                    var output$3 = $$Option.value(Curry._2(Pinc_Ast.StringMap.find_opt, right$17._0, left$2._0), /* Null */0);
                    return add_output(output$3, state);
                default:
...
function eval_function_call(state, $$arguments, left) {
  ...
  if (List.compare_lengths(parameters, $$arguments) <= 0) {
    return Stdlib.failwith(Curry._2(Printf.sprintf(/* Format */{
                        ...
                        _1: "This function only accepts %i arguments, but was provided %i here."
  ...
  return Stdlib.failwith(Curry._1(Printf.sprintf(/* Format */{
                      _0: {
                        TAG: /* String_literal */11,
                        _0: "This function was provided too few arguments. The following parameters are missing: ",
                        _1: {
                          TAG: /* String */2,
                          _0: /* No_padding */0,
                          _1: {
                      ...
                      _1: "This function was provided too few arguments. The following parameters are missing: %s."
                    }), missing));
}
...
function eval_let(state, ident, is_mutable, is_optional, expression) {
  ...
  if (typeof value === "number" && !is_optional) {
    ...
    return add_value_to_scope(ident, value, is_optional, is_mutable, state$1);
  }
}
...
function eval_block(state, exprs) {
...
function eval_tag(value, state, tag) {
  ...
  var get_output_typ = function (tag) {
    var tag_name = tag.tag_name;
    switch (tag_name) {
      case "Array" :
          var t = $$Option.map((function (t) {
                  if (t.TAG === /* TagExpression */13) {
                    return t._0;
                  } else {
                    return Stdlib.failwith("Expected attribute `of` to on #Array to be a tag, describing the type of the items of the array.");
                  }
                }), Curry._2(Pinc_Ast.StringMap.find_opt, "of", tag.attributes));
          var of$p = t !== undefined ? get_output_typ(t) : Stdlib.failwith("Expected attribute `of` to be present on #Array.");
          return {
                  TAG: /* Array */0,
                  _0: of$p
                };
      ...
      case "Record" :
          ...
          var of$p$1 = t$1 !== undefined ? Curry._2(Pinc_Ast.StringMap.mapi, (function (key, param) {
                    var expr = param[1];
                    if (expr.TAG === /* TagExpression */13) {
                      return [
                              param[0],
                              get_output_typ(expr._0)
                            ];
                    } else {
                      return Stdlib.failwith(Curry._1(Printf.sprintf(/* Format */{
                                          _0: {
                                            TAG: /* String_literal */11,
                                            _0: "expected property `",
                                            _1: {
                                              TAG: /* String */2,
                                              _0: /* No_padding */0,
                                              _1: {
                                                TAG: /* String_literal */11,
                                                _0: "` on record tag to be a tag, describing the type of the property.",
                                                _1: /* End_of_format */0
                                              }
                                            }
                                          },
                                          _1: "expected property `%s` on record tag to be a tag, describing the type of the property."
                                        }), key));
                    }
                  }), Caml_option.valFromOption(t$1)) : Stdlib.failwith("Expected attribute `of` to be present on #Record.");
          return {
                  TAG: /* Record */1,
                  _0: of$p$1
                };
  ...
  switch (tag_name) {
    case "Array" :
        if (!tag.exec) {
          ...
          var state$1 = add_tag(get_output_typ(tag), key, state);
          var l = apply_default_value($$default, value$1);
          if (typeof l === "number") {
            return add_output(/* Null */0, state$1);
          }
          switch (l.TAG | 0) {
            case /* String */0 :
            ...
            case /* Array */4 :
                var eval_item = function (item) {
                  return eval_tag(item, state$1, of$p);
                };
                ...
                return add_output(value$2, state$1);
            case /* Record */5 :
    ...
    case "Boolean" :
        if (!tag.exec) {
          ...
          var output = add_tag(get_output_typ(tag), key$1, state);
    ...
    case "Context" :
        ...
        if (tag.exec) {
          if (transformer$1 === undefined) {
            var name = Curry._2(Pinc_Ast.StringMap.find_opt, "name", attributes$2);
            var s = eval_expression(state, name !== undefined ? name : Stdlib.failwith("attribute name is required when setting a context.")).output;
            var name$1;
            name$1 = typeof s === "number" || s.TAG !== /* String */0 ? Stdlib.failwith("Expected attribute `name` on >#Context to be of type string.") : s._0;
            var value$4 = Curry._2(Pinc_Ast.StringMap.find_opt, "value", attributes$2);
            var value$5 = eval_expression(state, value$4 !== undefined ? value$4 : Stdlib.failwith("attribute value is required when setting a context.")).output;
            return add_output(/* Null */0, add_context(name$1, value$5, state));
          }
          
        } else {
          var $$default$2 = Curry._2(Pinc_Ast.StringMap.find_opt, "default", attributes$2);
          var name$2 = Curry._2(Pinc_Ast.StringMap.find_opt, "name", attributes$2);
          var s$1 = eval_expression(state, name$2 !== undefined ? name$2 : Stdlib.failwith("attribute name is required when getting a context.")).output;
          var name$3;
          name$3 = typeof s$1 === "number" || s$1.TAG !== /* String */0 ? Stdlib.failwith("Expected attribute `name` on #Context to be of type string.") : s$1._0;
          var value$6 = apply_default_value($$default$2, $$Option.value(get_context(name$3, state), /* Null */0));
          return add_output(apply_transformer(transformer$1, value$6), state);
        }
        break;
    case "Float" :
        if (!tag.exec) {
          ...
          var value$7 = get_value(key$2);
          var output$1 = add_tag(get_output_typ(tag), key$2, state);
          var f = apply_default_value($$default$3, value$7);
          if (typeof f === "number") {
    ...
    case "Int" :
        if (!tag.exec) {
          ...
          var output$2 = add_tag(get_output_typ(tag), key$3, state);
    ...
    case "Record" :
        if (!tag.exec) {
          ...
          var t$1 = $$Option.map((function (t) {
                ...
                }), Curry._2(Pinc_Ast.StringMap.find_opt, "of", attributes$5));
          var of$p$1 = t$1 !== undefined ? Curry._2(Pinc_Ast.StringMap.mapi, (function (key, param) {
                    var expr = param[1];
                    if (expr.TAG === /* TagExpression */13) {
                      return [
          ...
          var value$9 = get_value(key$4);
          var output$3 = add_tag(get_output_typ(tag), key$4, state);
          if (typeof value$9 === "number") {
            return add_output(/* Null */0, state);
          }
          switch (value$9.TAG | 0) {
            case /* String */0 :
            ...
            case /* Record */5 :
                ...
                var state$2 = make(models, undefined, undefined, state.declarations);
                var eval_property = function (key, param) {
                  var arg_binding_identifier = key;
                  var arg_models = state$2.models;
                  var arg_slotted_children = state$2.slotted_children;
                  var arg_declarations = state$2.declarations;
                  var arg_context = state$2.context;
                  var arg_output = state$2.output;
                  var arg_environment = state$2.environment;
                  var arg_tags = state$2.tags;
                  var arg = {
                    binding_identifier: arg_binding_identifier,
                    models: arg_models,
                    slotted_children: arg_slotted_children,
                  ...
                  var value = eval_tag(undefined, arg, param[1]).output;
                  if (typeof value === "number" && !param[0]) {
                    return Stdlib.failwith(Curry._1(Printf.sprintf(/* Format */{
                                        _0: {
                                          TAG: /* String_literal */11,
                                          ...
                                          _1: {
                                            ...
                                            _1: {
                                              TAG: /* String_literal */11,
                                              _0: "` on record tag is not marked as nullable, but was given a null value.",
                                              _1: /* End_of_format */0
                                            }
                                          }
                                        },
                                        _1: "property `%s` on record tag is not marked as nullable, but was given a null value."
                                      }), key));
                  } else {
                    return value;
                  }
                };
                var r$1 = Curry._2(Pinc_Ast.StringMap.mapi, eval_property, of$p$1);
                return add_output(apply_transformer(tag.transformer, {
                                TAG: /* Record */5,
                                _0: r$1
                              }), output$3);
            case /* Function */6 :
    ...
    case "Slot" :
        if (!tag.exec) {
          ...
          var s$2 = $$Option.value($$Option.map(get_output, $$Option.map((function (param) {
                          return eval_expression(state, param);
                        }), Curry._2(Pinc_Ast.StringMap.find_opt, "name", attributes$6))), {
                TAG: /* String */0,
                _0: ""
              });
          var slot_name;
          ...
          var i$1 = $$Option.value($$Option.map(get_output, $$Option.map((function (param) {
                          return eval_expression(state, param);
                        }), Curry._2(Pinc_Ast.StringMap.find_opt, "min", attributes$6))), {
                TAG: /* Int */1,
                _0: 0
              });
          var min;
          ...
          var param = $$Option.map(get_output, $$Option.map((function (param) {
                      return eval_expression(state, param);
                    }), Curry._2(Pinc_Ast.StringMap.find_opt, "max", attributes$6)));
          ...
          var param$1 = $$Option.map(get_output, $$Option.map((function (param) {
                      return eval_expression(state, param);
                    }), Curry._2(Pinc_Ast.StringMap.find_opt, "instanceOf", attributes$6)));
          ...
          var state$3 = add_tag(get_output_typ(tag), "__slot:" + slot_name, state);
          var children = state$3.slotted_children;
          if (children === undefined) {
            return add_output(/* Null */0, state$3);
          }
            ...
            switch (value.TAG | 0) {
              ...
              case /* TemplateNode */8 :
                  if (find_slot_key(value._2) === slot_name) {
                    ...
                    var arg = [];
                    return Stdlib.failwith(Curry._3(Printf.sprintf(/* Format */{
                                        _0: {
                                          TAG: /* String_literal */11,
                                          _0: "Child with tag `",
                                          _1: {
                                            ...
                                            _1: {
                                              TAG: /* String_literal */11,
                                              _0: "` may not be used inside the ",
                                              _1: {
                                                TAG: /* String */2,
                                                _0: /* No_padding */0,
                                                _1: {
                                                  TAG: /* String_literal */11,
                                                  _0: ". The following restrictions are set: [ ",
                                                  _1: {
                                                    TAG: /* String */2,
                                                    _0: /* No_padding */0,
                                                    _1: {
                                        ...
                                        _1: "Child with tag `%s` may not be used inside the %s. The following restrictions are set: [ %s ]"
                                      }), tag, slot_name === "" ? "Default #Slot." : Curry._1(Printf.sprintf(/* Format */{
                                              _0: {
                                                TAG: /* String_literal */11,
                                                _0: "#Slot with name `",
                                                _1: {
                                              ...
                                              _1: "#Slot with name `%s`"
                                            }), slot_name), $$String.concat(",", List.map((function (res) {
                                              return (
                                                      res.negated ? "!" : ""
                                                    ) + res.name;
          ...
          if (slot_name === "") {
            if (amount_of_children < min) {
              return Stdlib.failwith(Curry._1(Printf.sprintf(/* Format */{
                                  _0: {
                                    TAG: /* String_literal */11,
                                    _0: "Default #Slot did not reach the minimum amount of nodes (specified as ",
                                    _1: {
                                      TAG: /* Int */4,
                                      _0: /* Int_i */3,
                                      _1: /* No_padding */0,
                                  ...
                                  _1: "Default #Slot did not reach the minimum amount of nodes (specified as %i)."
                                }), min));
            }
            exit$1 = 3;
          } else {
              ...
              return Stdlib.failwith(Curry._2(Printf.sprintf(/* Format */{
                                  _0: {
                                    ...
                                    _1: {
                                      ...
                                      _1: {
                                        TAG: /* String_literal */11,
                                        _0: "` did not reach the minimum amount of nodes (specified as ",
                                        _1: {
                                          TAG: /* Int */4,
                                          _0: /* Int_i */3,
                                          _1: /* No_padding */0,
                                  ...
                                  _1: "#Slot with name `%s` did not reach the minimum amount of nodes (specified as %i)."
                                }), slot_name, min));
            }
            if (slot_name === "") {
              if (max === undefined) {
                return add_output(slotted_children$1, state$3);
              }
              if (amount_of_children > max) {
                return Stdlib.failwith(Curry._1(Printf.sprintf(/* Format */{
                                    _0: {
                                      TAG: /* String_literal */11,
                                      _0: "Default #Slot includes more than the maximum amount of nodes (specified as ",
                                      _1: {
                                        TAG: /* Int */4,
                                        _0: /* Int_i */3,
                                        _1: /* No_padding */0,
                                    ...
                                    _1: "Default #Slot includes more than the maximum amount of nodes (specified as %i)."
                                  }), max));
              }
              exit = 2;
            } else {
              ...
              return Stdlib.failwith(Curry._2(Printf.sprintf(/* Format */{
                                  _0: {
                                    ...
                                    _1: {
                                      ...
                                      _1: {
                                        TAG: /* String_literal */11,
                                        _0: "` includes more than the maximum amount of nodes (specified as ",
                                        _1: {
                                          TAG: /* Int */4,
                                          _0: /* Int_i */3,
                                          _1: /* No_padding */0,
                                  ...
                                  _1: "#Slot with name `%s` includes more than the maximum amount of nodes (specified as %i)."
                                }), slot_name, max));
            } else {
              return add_output(slotted_children$1, state$3);
            }
    ...
    case "String" :
        if (!tag.exec) {
          var transformer$4 = tag.transformer;
          var attributes$7 = tag.attributes;
          var $$default$5 = Curry._2(Pinc_Ast.StringMap.find_opt, "default", attributes$7);
          var key$5 = get_key(attributes$7);
          var value$10 = get_value(key$5);
          var output$4 = add_tag(get_output_typ(tag), key$5, state);
          var s$3 = apply_default_value($$default$5, value$10);
          if (typeof s$3 === "number") {
            return add_output(apply_transformer(transformer$4, /* Null */0), state);
          }
          switch (s$3.TAG | 0) {
            case /* String */0 :
                return add_output(apply_transformer(transformer$4, {
                                TAG: /* String */0,
                                _0: s$3._0
                              }), output$4);
            case /* Int */1 :
...
function $$eval(models, slotted_children, context, root, declarations) {
  ...
  if (declaration !== undefined) {
    ...
    return Stdlib.failwith(Curry._1(Printf.sprintf(/* Format */{
                        ...
                        _1: "Declaration with name `%s` was not found."
                      }), root));
  }
}
