...
function expect(token, t) {
  ...
  if (test) {
    ...
    return Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                TAG: /* Message */6,
                _0: Curry._2(Printf.sprintf(/* Format */{
                          _0: {
                          ...
                          _1: "Expected: `%s`, got `%s`"
                        }), Pinc_Token.to_string(token), Pinc_Token.to_string(t.token.typ))
              });
  }
}
...
function make(filename, src) {
  ...
  var initial_token = Pinc_Token.make(initial_pos, initial_pos, /* END_OF_INPUT */61);
  var t = {
    lexer: lexer,
    token: initial_token,
...
function separated_list(sep, fn, t) {
  ...
  while(true) {
    ...
    if (!(has_sep || Caml_obj.caml_equal(acc, /* [] */0))) {
      return Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                  TAG: /* Message */6,
                  _0: Curry._1(Printf.sprintf(/* Format */{
                            _0: {
                              TAG: /* String_literal */11,
                              _0: "Expected list to be separated by `",
                              _1: {
                                TAG: /* String */2,
                                _0: /* No_padding */0,
                                _1: {
                            ...
                            _1: "Expected list to be separated by `%s`"
                          }), Pinc_Token.to_string(sep))
                });
    }
    _acc = {
        ...
        if (right === undefined) {
          return Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                      ...
                      _0: Curry._1(Printf.sprintf(/* Format */{
                                _0: {
                                  TAG: /* String_literal */11,
                                  _0: "Expected expression on right hand side of `",
                                  _1: {
                                    TAG: /* String */2,
                                    _0: /* No_padding */0,
                                    _1: {
                                ...
                                _1: "Expected expression on right hand side of `%s`"
                              }), Pinc_Operators.Binary.to_string(operator))
                    });
        }
        var left$1 = {
          TAG: /* BinaryExpression */21,
          _0: left,
          _1: operator,
          _2: right
        };
...
function parse_expression_part(t) {
  var tag_name = t.token.typ;
  if (typeof tag_name === "number") {
    switch (tag_name) {
      case /* LEFT_PAREN */1 :
          next(t);
      ...
      case /* LEFT_BRACE */5 :
          ...
          if (is_record) {
            var attrs = Curry._1(Pinc_Ast.StringMap.of_seq, List.to_seq(separated_list(/* COMMA */12, parse_record_field, t)));
          ...
          var expressions$1 = list((function (eta) {
                  return parse_expression(undefined, eta);
                }), t);
          expect(/* RIGHT_BRACE */6, t);
          return {
                  TAG: /* BlockExpression */18,
                  _0: expressions$1
                };
      case /* DOUBLE_QUOTE */9 :
          next(t);
      ...
      case /* KEYWORD_LET */42 :
          ...
          expect(/* SEMICOLON */13, t);
          if (expression !== undefined) {
            if (nullable) {
              return {
                      TAG: /* OptionalLetExpression */10,
                      _0: is_mutable,
                      _1: /* Lowercase_Id */{
                        _0: identifier
                      },
            ...
            return Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                        TAG: /* Message */6,
                        _0: Printf.sprintf(/* Format */{
                              _0: {
                                TAG: /* String_literal */11,
                                _0: "Expected expression as right hand side of let declaration",
                                _1: /* End_of_format */0
                              },
                              _1: "Expected expression as right hand side of let declaration"
                            })
                      });
          }
      case /* KEYWORD_TRUE */44 :
      ...
      case /* KEYWORD_IF */46 :
          ...
          return $$Option.bind(parse_expression(undefined, t), (function (condition) {
                        expect(/* RIGHT_PAREN */2, t);
                        var consequent = list((function (eta) {
                                return parse_expression(undefined, eta);
                              }), t);
                        var alternate = optional(/* KEYWORD_ELSE */47, t) ? list((function (eta) {
                                  return parse_expression(undefined, eta);
                                }), t) : undefined;
                        return {
                                TAG: /* ConditionalExpression */19,
                                condition: condition,
                        ...
                        if (body) {
                          ...
                          return Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                                      ...
                                      _0: Printf.sprintf(/* Format */{
                                            _0: {
                                              TAG: /* String_literal */11,
                                              _0: "Expected expression as body of for loop",
                                              _1: /* End_of_format */0
                                            },
                                            _1: "Expected expression as body of for loop"
                                          })
                                    });
                        }
                      }));
      case /* KEYWORD_BREAK */51 :
          next(t);
          expect(/* KEYWORD_IF */46, t);
          expect(/* LEFT_PAREN */1, t);
          return $$Option.bind(parse_expression(undefined, t), (function (condition) {
                        expect(/* RIGHT_PAREN */2, t);
                        expect(/* SEMICOLON */13, t);
                        return {
                                TAG: /* BreakExpression */14,
                                _0: condition
                              };
                      }));
      case /* KEYWORD_CONTINUE */52 :
      ...
      case /* HTML_OPEN_FRAGMENT */57 :
          ...
          expect(/* HTML_CLOSE_FRAGMENT */58, t);
          return {
                  TAG: /* TemplateExpression */17,
                  _0: template_nodes
                };
      default:
        return ;
    ...
    switch (tag_name.TAG | 0) {
      case /* IDENT_LOWER */0 :
          var identifier$2 = tag_name._0;
          next(t);
          var is_mutation = optional(/* COLON_EQUAL */23, t);
          if (!is_mutation) {
            return {
          ...
          var expression$2 = expression$1 !== undefined ? expression$1 : Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                  ...
                  _0: Printf.sprintf(/* Format */{
                        _0: {
                          TAG: /* String_literal */11,
                          _0: "Expected expression as right hand side of mutation expression",
                          _1: /* End_of_format */0
                        },
                        _1: "Expected expression as right hand side of mutation expression"
                      })
                });
          expect(/* SEMICOLON */13, t);
          return {
                  TAG: /* MutationExpression */12,
                  _0: /* Lowercase_Id */{
                    _0: identifier$2
                  },
                  _1: expression$2
      ...
      case /* TAG */5 :
          ...
          if (optional(/* LEFT_PAREN */1, t)) {
            var res = Curry._1(Pinc_Ast.StringMap.of_seq, List.to_seq(separated_list(/* COMMA */12, (function (eta) {
                            return parse_attribute(undefined, eta);
                          }), t)));
            expect(/* RIGHT_PAREN */2, t);
            attributes = res;
          } else {
            attributes = Pinc_Ast.StringMap.empty;
          }
          var transformer;
          if (optional(/* DOUBLE_COLON */11, t)) {
            ...
            var body$1 = expr$1 !== undefined ? expr$1 : Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                    TAG: /* Message */6,
                    _0: Printf.sprintf(/* Format */{
                          _0: {
                            TAG: /* String_literal */11,
                          ...
                          _1: "Expected expression as transformer of tag"
                        })
                  });
            transformer = [
              /* Lowercase_Id */{
          ...
          return {
                  TAG: /* TagExpression */13,
                  _0: {
                    tag_name: tag_name._0,
      ...
      case /* TAG_EXEC */6 :
          next(t);
          expect(/* LEFT_PAREN */1, t);
          var attributes$1 = Curry._1(Pinc_Ast.StringMap.of_seq, List.to_seq(separated_list(/* COMMA */12, (function (eta) {
                          return parse_attribute(undefined, eta);
                        }), t)));
          expect(/* RIGHT_PAREN */2, t);
          expect(/* SEMICOLON */13, t);
      ...
      case /* HTML_OPEN_TAG */7 :
      case /* COMPONENT_OPEN_TAG */9 :
          break;
      default:
        return ;
    }
  ...
  if (typeof s === "number") {
    ...
    switch (s.TAG | 0) {
      ...
      case /* HTML_OPEN_TAG */7 :
          ...
          var attributes = Curry._1(Pinc_Ast.StringMap.of_seq, List.to_seq(list((function (param) {
                          return parse_attribute(partial_arg, param);
                        }), t)));
          var self_closing = optional(/* HTML_OR_COMPONENT_TAG_SELF_CLOSING */59, t);
          var children;
          if (self_closing) {
            children = /* [] */0;
          } else {
            expect(/* HTML_OR_COMPONENT_TAG_END */60, t);
            var children$1 = list(parse_template_node, t);
            expect({
                  TAG: /* HTML_CLOSE_TAG */8,
                  _0: tag
                }, t);
            children = children$1;
          }
      ...
      case /* COMPONENT_OPEN_TAG */9 :
          ...
          var attributes$1 = Curry._1(Pinc_Ast.StringMap.of_seq, List.to_seq(list((function (param) {
                          return parse_attribute(partial_arg$1, param);
                        }), t)));
          var self_closing$1 = optional(/* HTML_OR_COMPONENT_TAG_SELF_CLOSING */59, t);
          var children$2;
          if (self_closing$1) {
            children$2 = /* [] */0;
          } else {
...
function scan(t) {
  return Curry._1(Pinc_Ast.StringMap.of_seq, List.to_seq(list(parse_declaration, t)));
}

function parse(filename, source) {
  return scan(make(filename, source));
}
