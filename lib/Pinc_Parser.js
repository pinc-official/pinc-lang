...
function make(filename, src) {
  ...
  var initial_token = Pinc_Token.make(initial_pos, initial_pos, /* END_OF_INPUT */63);
  var t = {
    lexer: lexer,
    token: initial_token,
...
function parse_binary_operator(t) {
  ...
  switch (match) {
    ...
    case /* KEYWORD_FN */42 :
    case /* KEYWORD_LET */43 :
    case /* KEYWORD_MUTABLE */44 :
    case /* KEYWORD_TRUE */45 :
    case /* KEYWORD_FALSE */46 :
    case /* KEYWORD_IF */47 :
    case /* KEYWORD_ELSE */48 :
    case /* KEYWORD_FOR */49 :
    case /* KEYWORD_IN */50 :
    case /* KEYWORD_REVERSE */51 :
    case /* KEYWORD_BREAK */52 :
    case /* KEYWORD_CONTINUE */53 :
    case /* KEYWORD_COMPONENT */54 :
    case /* KEYWORD_LIBRARY */55 :
    case /* KEYWORD_SITE */56 :
    case /* KEYWORD_PAGE */57 :
    case /* KEYWORD_STORE */58 :
    case /* HTML_OPEN_FRAGMENT */59 :
    case /* HTML_CLOSE_FRAGMENT */60 :
    case /* HTML_OR_COMPONENT_TAG_SELF_CLOSING */61 :
    case /* HTML_OR_COMPONENT_TAG_END */62 :
    case /* END_OF_INPUT */63 :
        return ;
  ...
  if (typeof name === "number") {
    switch (name) {
      ...
      case /* KEYWORD_IF */47 :
          ...
          return $$Option.bind(parse_expression(undefined, t), (function (condition) {
                        ...
                        return $$Option.bind(parse_statement(t), (function (consequent) {
                                      var alternate = optional(/* KEYWORD_ELSE */48, t) ? parse_statement(t) : undefined;
                                      return {
      ...
      case /* KEYWORD_FOR */49 :
          ...
          expect(/* KEYWORD_IN */50, t);
          var reverse = optional(/* KEYWORD_REVERSE */51, t);
      ...
      case /* HTML_OPEN_FRAGMENT */59 :
          ...
          expect(/* HTML_CLOSE_FRAGMENT */60, t);
          return {
  ...
  if (typeof s === "number") {
    ...
    switch (s.TAG | 0) {
      ...
      case /* HTML_OPEN_TAG */6 :
          ...
          var self_closing = optional(/* HTML_OR_COMPONENT_TAG_SELF_CLOSING */61, t);
          var children;
          if (self_closing) {
            children = /* [] */0;
          } else {
            expect(/* HTML_OR_COMPONENT_TAG_END */62, t);
      ...
      case /* COMPONENT_OPEN_TAG */8 :
          ...
          var self_closing$1 = optional(/* HTML_OR_COMPONENT_TAG_SELF_CLOSING */61, t);
          var children$2;
          if (self_closing$1) {
            children$2 = /* [] */0;
          } else {
...
function parse_statement(t) {
  ...
  if (typeof identifier === "number") {
    switch (identifier) {
      case /* KEYWORD_USE */41 :
          next(t);
          var identifier$1 = expect_identifier("Upper", t);
          expect(/* EQUAL */22, t);
          var expression = parse_expression(undefined, t);
          var expression$1 = expression !== undefined ? expression : Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                  TAG: /* Message */6,
                  _0: "Expected expression as right hand side of use statement"
                });
      ...
      case /* KEYWORD_LET */43 :
          next(t);
          var is_mutable = optional(/* KEYWORD_MUTABLE */44, t);
          var identifier$2 = expect_identifier("Lower", t);
          var is_nullable = optional(/* QUESTIONMARK */21, t);
          expect(/* EQUAL */22, t);
          var expression$2 = parse_expression(undefined, t);
          optional(/* SEMICOLON */13, t);
          var exit = 0;
          if (is_mutable) {
            if (is_nullable) {
              if (expression$2 !== undefined) {
                return {
                        TAG: /* OptionalMutableLetStatement */1,
                        _0: /* Lowercase_Id */{
                          _0: identifier$2
                        },
                        _1: expression$2
    ...
    next(t);
    next(t);
    var expression$3 = parse_expression(undefined, t);
    var expression$4 = expression$3 !== undefined ? expression$3 : Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
            TAG: /* Message */6,
            _0: "Expected expression as right hand side of mutation statement"
          });
    optional(/* SEMICOLON */13, t);
    return {
            TAG: /* MutationStatement */5,
            _0: /* Lowercase_Id */{
              _0: identifier._0
            },
            _1: expression$4
