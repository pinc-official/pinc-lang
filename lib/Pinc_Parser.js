...
function parse_tag(name, t) {
  ...
  if (optional(/* DOUBLE_COLON */11, t)) {
    ...
    var body = expr !== undefined ? expr : Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
            TAG: /* Message */6,
...
function parse_statement(t) {
  ...
  if (typeof name === "number") {
    ...
    switch (name.TAG | 0) {
      case /* IDENT_LOWER */0 :
          if (Caml_obj.caml_equal(peek(t), /* COLON_EQUAL */23)) {
            next(t);
            next(t);
            ...
            var expression$2 = expression$1 !== undefined ? expression$1 : Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                    ...
                    _0: Printf.sprintf(/* Format */{
                          ...
                          _1: "Expected expression as right hand side of mutation statement"
                        })
                  });
            expect(/* SEMICOLON */13, t);
            return {
      ...
      case /* TAG */5 :
          next(t);
          return $$Option.bind(parse_tag(name._0, t), (function (tag) {
                        expect(/* SEMICOLON */13, t);
                        return {
                        ...
                        if (body !== undefined) {
                          ...
                          return Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                                      ...
                                      _0: Printf.sprintf(/* Format */{
                                            ...
                                            _1: "Expected statement as body of for loop"
                                          })
                                    });
                        }
                      }));
...
function parse_declaration(t) {
  ...
  if (typeof typ === "number") {
    if (typ >= 57) {
      ...
      var body = list(parse_statement, t);
      expect(/* RIGHT_BRACE */6, t);
      if (!body) {
        return Pinc_Diagnostics.report(t.token.start_pos, t.token.end_pos, {
                    TAG: /* Message */6,
