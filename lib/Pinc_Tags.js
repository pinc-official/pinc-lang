...
function $$eval(self, state, info) {
  ...
  return Result.map(Curry._1(self.transform, info), Curry._2(self.validate, info, $$Option.value(v !== undefined && v !== "Null" ? v : $$default, "Null")));
}
...
function $$eval$4(self, state, info) {
  ...
  var $$default = Curry._2(StringMap.find_opt, "default", attributes);
  var v = Curry._2(self.get_value, state, key);
  var validated_data = Curry._2(self.validate, info, $$Option.value(v !== undefined && v !== "Null" ? v : $$default, "Null"));
  return Result.map(Curry._1(self.transform, info), Result.bind(validated_data, (function (param) {
...
function $$eval$5(self, state, info) {
  ...
  var $$default = Curry._2(StringMap.find_opt, "default", attributes);
  var v = Curry._2(self.get_value, state, key);
  return Result.map(Curry._1(self.transform, info), Result.map((function (param) {
                    if (typeof param === "string") {
                      if (param === "Null") {
                        return "Null";
                      } else {
                  ...
                  }), Curry._2(self.validate, info, $$Option.value(v !== undefined && v !== "Null" ? v : $$default, "Null"))));
}
...
function validate$6(info, value) {
  var attributes = info[2];
  var param = $$Option.value(Curry._2(StringMap.find_opt, "min", attributes), {
        NAME: "Int",
        VAL: 0
      });
  var min = typeof param === "string" || param.NAME !== "Int" ? Stdlib.failwith("Expected attribute `min` on #Slot to be of type int.") : param.VAL;
  var param$1 = Curry._2(StringMap.find_opt, "max", attributes);
  var max = param$1 !== undefined ? (
      typeof param$1 === "string" || param$1.NAME !== "Int" ? Stdlib.failwith("Expected attribute `max` on #Slot to be of type int.") : param$1.VAL
    ) : Int.max_int;
  var param$2 = Curry._2(StringMap.find_opt, "instanceOf", attributes);
  var instanceOf = param$2 !== undefined ? (
      typeof param$2 === "string" || param$2.NAME !== "Array" ? Stdlib.failwith("Expected attribute `instanceOf` on #Slot to be an array.") : $$Array.map((function (param) {
...
function get_value$6(state, key) {
  ...
  var keep_slotted = function (acc, param) {
    if (typeof param === "string") {
    ...
    if (variant !== "ComponentTemplateNode") {
      if (variant === "Array") {
        return $$Array.fold_left(keep_slotted, acc, param.VAL);
      } else {
        return Stdlib.failwith("Only nodes may be placed into slots. If you want to put a plain text into a slot, you have to wrap it in a <p></p> tag for example.");
      }
    }
    var match$1 = param.VAL;
    var attributes$1 = match$1[2];
  ...
  if (list) {
    return {
            NAME: "Array",
            VAL: $$Array.of_list(List.rev(list))
          };
  }
...
function $$eval$6(self, state, info) {
  var param = $$Option.value(Curry._2(StringMap.find_opt, "name", info[2]), {
        NAME: "String",
        VAL: ""
      });
...
function $$eval$7(self, state, info) {
  ...
  return Result.map(Curry._1(self.transform, info), Curry._2(self.validate, info, $$Option.value(Curry._2(self.get_value, state, name), "Null")));
}
