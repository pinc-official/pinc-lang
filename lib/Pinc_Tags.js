...
function validate$6(info, value) {
  ...
  var instanceOf = param$1 !== undefined ? (
      typeof param$1 === "number" || param$1.TAG !== /* Array */5 ? Stdlib.failwith("Expected attribute `instanceOf` on #Slot to be an array.") : $$Array.map((function (info) {
...
function get_value$9(state, key) {
  return Hashtbl.find_opt(state.portals, key);
}
...
function $$eval$9(self, state, info) {
  ...
  if (match || Hashtbl.mem(state.portals, name)) {
    
  } else {
    Hashtbl.add(state.portals, name, {
          TAG: /* Portal */0,
          _0: {
            TAG: /* Array */5,
            _0: []
  ...
  return Result.map(Curry._1(self.transform, info), Curry._2(self.validate, info, (function (param) {
                      return $$Option.value(param, arg);
                    })(Curry._2(self.get_value, state, name))));
}
...
function $$eval$10(self, state, info) {
  ...
  var match = state.mode;
  if (!match) {
    var match$1 = Hashtbl.find_opt(state.portals, name);
    if (match$1 !== undefined) {
      var exit = 0;
      if (typeof match$1 === "number" || match$1.TAG !== /* Portal */0) {
        exit = 1;
      } else {
        var array = match$1._0;
        if (typeof array === "number" || array.TAG !== /* Array */5) {
          exit = 1;
        } else {
          Hashtbl.replace(state.portals, name, {
                ...
                _0: {
                  TAG: /* Array */5,
                  _0: $$Array.append(array._0, [push$1])
                }
              });
        }
      }
