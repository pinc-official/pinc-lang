...
function $$eval(self, state, info) {
  ...
  var key = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `key` #String to be of type string") : param._0
...
function $$eval$1(self, state, info) {
  ...
  var param = Curry._2(StringMap.find_opt, "key", attributes);
  var key = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `key` #Int to be of type string") : param._0
...
function $$eval$2(self, state, info) {
  ...
  var param = Curry._2(StringMap.find_opt, "key", attributes);
  var key = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `key` #Float to be of type string") : param._0
...
function $$eval$3(self, state, info) {
  ...
  var param = Curry._2(StringMap.find_opt, "key", attributes);
  var key = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `key` #Boolean to be of type string") : param._0
...
function $$eval$4(self, state, info) {
  ...
  var param = Curry._2(StringMap.find_opt, "key", attributes);
  var key = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `key` #Array to be of type string") : param._0
  ...
  var of_info = param$1 !== undefined ? (
      typeof param$1 === "number" || param$1.TAG !== /* TagInfo */9 ? Stdlib.failwith("Expected attribute `of` #Array to be a tag describing the type of the items inside.") : param$1._0
...
function $$eval$5(self, state, info) {
  ...
  var param = Curry._2(StringMap.find_opt, "key", attributes);
  var key = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `key` #Record to be of type string") : param._0
    ) : Stdlib.failwith("Expected attribute `key` to exist on #Record");
  var param$1 = Curry._2(StringMap.find_opt, "of", attributes);
  var of$p = param$1 !== undefined ? (
      typeof param$1 === "number" || param$1.TAG !== /* Record */6 ? Stdlib.failwith("Expected attribute `of` #Array to be a tag describing the type of the items inside.") : Curry._2(StringMap.filter_map, (function (_key, i) {
                if (typeof i === "number" || i.TAG !== /* TagInfo */9) {
                  return ;
                } else {
                  return i._0;
                }
...
function validate$6(info, value) {
  ...
  var min;
  min = typeof i === "number" || i.TAG !== /* Int */2 ? Stdlib.failwith("Expected attribute `min` on #Slot to be of type int.") : i._0;
  var param = Curry._2(StringMap.find_opt, "max", attributes);
  var max = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* Int */2 ? Stdlib.failwith("Expected attribute `max` on #Slot to be of type int.") : param._0
    ) : Int.max_int;
  var param$1 = Curry._2(StringMap.find_opt, "constraints", attributes);
  var constraints = param$1 !== undefined ? (
      typeof param$1 === "number" || param$1.TAG !== /* Array */5 ? Stdlib.failwith("Expected attribute `constraints` on #Slot to be an array.") : $$Array.map((function (info) {
                if (typeof info === "number" || info.TAG !== /* DefinitionInfo */8) {
                  return Stdlib.failwith("Expected attribute `constraints` on #Slot to be an array of uppercase identifiers.");
                } else {
                  return info._0;
                }
              }), param$1._0)
...
function $$eval$6(self, state, info) {
  ...
  var slot_name;
  slot_name = typeof s === "number" || s.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `name` on #Slot to be of type string.") : s._0;
  var arg = {
    TAG: /* Array */5,
    _0: []
  };
...
function $$eval$7(self, state, info) {
  ...
  var name = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `name` on #SetContext to be of type string.") : param._0
  ...
  var value$1 = value !== undefined ? (
      typeof value === "number" || value.TAG !== /* Function */7 ? value : Stdlib.failwith("a function can not be put into a context.")
...
function validate$8(_info, value) {
  if (typeof value === "number" || value.TAG !== /* TagInfo */9) {
    return Result.ok(value);
  } else {
    return Result.error("Something unexpected happened...this is my fault, not yours");
  }
...
function $$eval$8(self, state, info) {
  ...
  var param = Curry._2(StringMap.find_opt, "name", attributes);
  var name = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `name` on #GetContext to be of type string.") : param._0
...
function validate$9(_info, value) {
  if (typeof value === "number") {
    return Result.error("Something unexpected happened...this is my fault, not yours");
  }
  switch (value.TAG | 0) {
...
function get_value$9(state, key) {
  return {
          TAG: /* Portal */0,
          _0: Hashtbl.find_all(state.portals, key)
        };
}

function $$eval$9(self, state, info) {
  var param = Curry._2(StringMap.find_opt, "name", info[2]);
  var name = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `name` on #CreatePortal to be of type string.") : param._0
    ) : Stdlib.failwith("attribute name is required when creating a portal.");
  return Result.map(Curry._1(self.transform, info), Curry._2(self.validate, info, $$Option.value(Curry._2(self.get_value, state, name), {
                      TAG: /* Portal */0,
                      _0: /* [] */0
                    })));
}
...
var create_portal = {
  validate: validate$9,
  transform: transform,
  get_value: get_value$9,
  eval: $$eval$9
};

function validate$10(_info, value) {
  if (typeof value === "number") {
    return Result.ok(/* Null */0);
  }
  switch (value.TAG | 0) {
...
function get_value$10(_state, _key) {
  return /* Null */0;
}

function $$eval$10(self, state, info) {
  var attributes = info[2];
  var param = Curry._2(StringMap.find_opt, "name", attributes);
  var name = param !== undefined ? (
      typeof param === "number" || param.TAG !== /* String */1 ? Stdlib.failwith("Expected attribute `name` on #Portal to be of type string.") : param._0
    ) : Stdlib.failwith("attribute name is required when pushing a value into a portal.");
  var push = Curry._2(StringMap.find_opt, "push", attributes);
  var push$1 = push !== undefined ? (
      typeof push === "number" || push.TAG !== /* Function */7 ? push : Stdlib.failwith("a function can not be put into a portal.")
    ) : Stdlib.failwith("attribute push is required when pushing a value into a portal.");
  var match = state.mode;
  if (match) {
    
  } else {
    Hashtbl.add(state.portals, name, push$1);
  }
  return Result.map(Curry._1(self.transform, info), Curry._2(self.validate, info, $$Option.value(Curry._2(self.get_value, state, name), /* Null */0)));
}
