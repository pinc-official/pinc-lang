  ...
  if (match$1 < 63) {
    if (match$1 !== 47) {
      ...
      switch (match$1) {
        ...
        case 62 :
            next(t);
            return /* HTML_OR_COMPONENT_TAG_END */62;
      ...
      if (c$1 !== 62) {
        ...
        popMode(/* Template */4, t);
        next_n(2, t);
        return /* HTML_OR_COMPONENT_TAG_SELF_CLOSING */61;
      }
    }
  } else {
    switch (match$1) {
