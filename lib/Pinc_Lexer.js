    ...
    return Pinc_Diagnostics.report(start_pos, make_position(t), {
                ...
                _0: Curry._1(Printf.sprintf(/* Format */{
                          _0: {
                            ...
                            _0: "Invalid Tag! Tags have to start with an uppercase character. Did you mean to write #",
                            _1: {
                              TAG: /* String */2,
                              _0: /* No_padding */0,
                              _1: {
                          ...
                          _1: "Invalid Tag! Tags have to start with an uppercase character. Did you mean to write #%s?"
  ...
  if (match > 122 || match < 97) {
    return Pinc_Diagnostics.report(start_pos, make_position(t), {
                ...
                _0: Curry._1(Printf.sprintf(/* Format */{
                          _0: {
                            TAG: /* String_literal */11,
                            _0: "Invalid HTML tag! HTML tags have to start with a lowercase letter. Instead saw: ",
                            _1: {
                              TAG: /* String */2,
                              _0: /* No_padding */0,
                              _1: /* End_of_format */0
                          ...
                          _1: "Invalid HTML tag! HTML tags have to start with a lowercase letter. Instead saw: %s"
                        }), ident)
              });
  } else {
    return ident;
  ...
  if (c > 90 || c < 65) {
    return Pinc_Diagnostics.report(start_pos, make_position(t), {
                ...
                _0: Curry._1(Printf.sprintf(/* Format */{
                          _0: {
                            TAG: /* String_literal */11,
                            _0: "Invalid Component tag! Component tags have to start with an uppercase letter. Instead saw: ",
                            _1: {
                              TAG: /* Char */0,
                              _0: /* End_of_format */0
                            }
                          },
                          _1: "Invalid Component tag! Component tags have to start with an uppercase letter. Instead saw: %c"
                        }), c)
              });
  } else {
    return {
            TAG: /* COMPONENT_OPEN_TAG */9,
  ...
  if (c > 122 || c < 97) {
    return Pinc_Diagnostics.report(start_pos, make_position(t), {
                ...
                _0: Curry._1(Printf.sprintf(/* Format */{
                          _0: {
                            TAG: /* String_literal */11,
                            _0: "Invalid Template tag! Template tags have to start with a lowercase letter. Instead saw: ",
                            _1: {
                              TAG: /* Char */0,
                              _0: /* End_of_format */0
                            }
                          },
                          _1: "Invalid Template tag! Template tags have to start with a lowercase letter. Instead saw: %c"
                        }), c)
              });
  } else {
    return {
  ...
  if (match$1 < 63) {
    if (match$1 !== 47) {
      ...
      switch (match$1) {
        case 60 :
            ...
            return Pinc_Diagnostics.report(start_pos, make_position(t), {
                        ...
                        _0: Curry._1(Printf.sprintf(/* Format */{
                                  _0: {
                                    TAG: /* String_literal */11,
                                    _0: "Invalid Template tag! Template tags have to start with an uppercase or lowercase letter. Instead saw: ",
                                    _1: {
                                      TAG: /* Char */0,
                                      _0: /* End_of_format */0
                                    }
                                  },
                                  _1: "Invalid Template tag! Template tags have to start with an uppercase or lowercase letter. Instead saw: %c"
                                }), c)
                      });
            break;
        case 61 :
        ...
        case 62 :
            next(t);
            return /* HTML_OR_COMPONENT_TAG_END */60;
      ...
      if (c$1 !== 62) {
        ...
        popMode(/* Template */4, t);
        next_n(2, t);
        return /* HTML_OR_COMPONENT_TAG_SELF_CLOSING */59;
      }
    }
  } else {
    switch (match$1) {
...
function scan_token(start_pos, t) {
  ...
  switch (match) {
    case /* Normal */0 :
        ...
        switch (c) {
          ...
          case 62 :
              ...
              if (typeof match$17 === "string") {
                next(t);
                return /* GREATER */25;
              }
              if (match$17.NAME === "Chr") {
                ...
                var match$19 = peek(2, t);
                var exit$5 = 0;
                if (typeof match$19 === "string") {
                  exit$5 = 2;
                } else {
                  if (match$19.NAME === "Chr" && (match$19.VAL - 65 >>> 0) <= 25) {
                    next_n(2, t);
                    return {
                            TAG: /* TAG_EXEC */6,
                            _0: scan_tag(t)
          ...
          case 64 :
              var match$20 = peek(undefined, t);
              var exit$6 = 0;
              if (typeof match$20 === "string") {
                exit$6 = 2;
              } else {
                if (match$20.NAME === "Chr" && match$20.VAL === 64) {
                  next_n(2, t);
                  return /* ATAT */20;
                }
                exit$6 = 2;
          ...
          case 123 :
              ...
              return /* LEFT_BRACE */5;
          case 124 :
              var match$21 = peek(undefined, t);
              var exit$7 = 0;
              if (typeof match$21 === "string" || match$21.NAME !== "Chr") {
                exit$7 = 2;
              } else {
                var match$22 = match$21.VAL;
                if (match$22 === 125 || match$22 === 124) {
                  if (match$22 >= 125) {
                    popMode(/* Normal */0, t);
                    next_n(2, t);
    ...
    case /* String */1 :
        ...
        if (match$23.NAME !== "Chr") {
          return scan_string(start_pos, t);
        }
        var match$24 = match$23.VAL;
        if (match$24 === 124 || match$24 === 123) {
          if (match$24 >= 124) {
    ...
    case /* TemplateAttributes */2 :
        ...
        if (match$26 >= 62) {
          ...
          if (match$26 !== 34) {
            ...
            var match$27 = peek(undefined, t);
            if (typeof match$27 === "string") {
              return Pinc_Diagnostics.report(start_pos, make_position(t), /* NonTerminatedTemplate */1);
            }
            var c$3 = match$27.VAL;
            if (c$3 !== 62) {
              return Pinc_Diagnostics.report(start_pos, make_position(t), {
                          TAG: /* UnknownCharacter */0,
                          _0: c$3
    ...
    case /* ComponentAttributes */3 :
        var match$28 = t.current;
        if (typeof match$28 === "string") {
          return Pinc_Diagnostics.report(start_pos, make_position(t), /* NonTerminatedTemplate */1);
        }
        var match$29 = match$28.VAL;
        if (match$29 >= 62) {
          if (match$29 < 97) {
            if (match$29 !== 95) {
              if (match$29 >= 63) {
          ...
          if (match$29 !== 34) {
            ...
            var match$30 = peek(undefined, t);
            if (typeof match$30 === "string") {
              return Pinc_Diagnostics.report(start_pos, make_position(t), /* NonTerminatedTemplate */1);
            }
            var c$4 = match$30.VAL;
            if (c$4 !== 62) {
              return Pinc_Diagnostics.report(start_pos, make_position(t), {
                          TAG: /* UnknownCharacter */0,
                          _0: c$4
...
/* Pinc_Diagnostics Not a pure module */
