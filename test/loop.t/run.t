  ...
  <section>
        ...
        10..0 reverse
        <div class="item">10</div><div class="item">9</div><div class="item">8</div><div class="item">7</div><div class="item">6</div><div class="item">5</div><div class="item">4</div><div class="item">3</div><div class="item">2</div><div class="item">1</div>
        ...
        string reverse
        <div class="item">!</div><div class="item">g</div><div class="item">n</div><div class="item">i</div><div class="item">r</div><div class="item">t</div><div class="item">S</div>
  
        string array
        <div class="item">one</div><div class="item">two</div><div class="item">three</div><div class="item">!</div>
